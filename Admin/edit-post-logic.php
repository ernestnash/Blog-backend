...
if (isset($_POST['submit'])) {
        ...
        if ($thumbnail['name']) {
            ...
            if (in_array($extension, $allowed_files)) {
                ...
                if ($thumbnail['size'] < 2000000) {
                    ...
                    $_SESSION['add-post'] = "Couldn't update post. file size too big. should be less than 2 MB";
                }
            } else {
                $_SESSION['add-post'] = "Couldn't update post. file should be jpg, png or jpeg.";
            }
        }
    ...
    if ($_SESSION['edit-post']) {
        ...
        //set featured of all posts to 0 if featured for this post is 1
        if($is_featured == 1){
            $zero_all_if_featured_query = "UPDATE posts SET is_featured = 0 ";
            $zero_all_if_featured_result = mysqli_query($connection, $zero_all_if_featured_query);
        }
        //set thumbnail name if a new on is uploaded, else keep old thumbnail name
