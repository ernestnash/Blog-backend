...
?>
    ...
    <?php if(isset($_SESSION['add-post-success'])) : //shows if add post was successful?> 
        ...
        <?php elseif(isset($_SESSION['add-post'])) : //shows if add post was NOT successful?> 
        ...
        </div><?php elseif(isset($_SESSION['delete-post'])) : //shows if delete post was NOT successful?> 
        <div class="alert-message error container">
            <p>
        ...
        <div class="container dashboard-container">
            ...
            <aside>
                <ul>
                    ...
                    <li>
                        <a href="index.php" class="active"><i class="fa fa-address-card"></i>
                            <h5>Manage Posts</h5>
                        </a>
                    </li>
            ...
            <main>
                ...
                <table>
                    ...
                    <?php while($post = mysqli_fetch_assoc($posts)) : ?>
                        <!-- grt category title of each post from category table -->
                        <?php 
